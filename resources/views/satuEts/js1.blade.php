    ...
    <head>
        ...
        <script>
            // function dibuat agar tidak langsung di load waktu web dibuka tapi sesuai kebutuhan(kalo dipanggil)
            // execute js ada di console, klo kosong artinya ga eror
            function hello()
            {
            ...
            function tambah()
            {
                ...
                // use innerhtml karna bukan bagian dari form
